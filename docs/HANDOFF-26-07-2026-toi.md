...
6. **MAP SCREEN FULL-SIZE (M1–M4 HOÀN THÀNH)** — xem `docs/KE-HOACH-mapscreen-fullsize.md`:
   ...
   - M4 (layout responsive theo yêu cầu Ethan):
     ...
     * **History log**: chiếm đáy cột trái, **cố định top y=362** (roster và panel inventory đều kết thúc 359). Wrap chữ 222px, ~35 dòng, nút cuộn x=239, thanh trượt động. `MapScreenLogTop()` trong `Map_Screen_Interface_Bottom.cc`.
...
4. **Panel inventory tactical** (`Inventory_bottom_panel.sti` 1024×140) — chưa xử lý, mở túi đồ trong tactical có thể lệch như bottom bar cũ.
