...
Repo: local `Ethanhoangdesign/OldGameVM` path  
...
Upstream: https://ja2-stracciatella.github.io/download/ + GitHub releases
...
| Controller remap UI Android | **Khong** (desktop only) |
...
### 2.3 Landscape lock (bat buoc cho 1366×768)
...
1. `android/app/src/main/AndroidManifest.xml` — `StracciatellaActivity`:
   ```xml
...
Launcher (`LauncherActivity`) van doc — OK.
...
5. Controller remap: desktop only.
...
# emu start / kill
emulator -avd Pronunciation_API_35 &
adb -s emulator-5554 emu kill
```

---

## 12. SESSION TOM TAT (06/08)
